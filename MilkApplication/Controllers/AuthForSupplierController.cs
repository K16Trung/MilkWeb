...
namespace MilkApplication.Controllers
{
    ...
    public class AuthForSupplierController : ControllerBase
    {
        private readonly IAuthService _authService;
        private readonly JwtHelper _jwtHelper;
        private readonly UserManager<ApplicationUser> _userManager;

        public AuthForSupplierController(IAuthService authService, JwtHelper jwtHelper, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterDTO model)
        {
            ...
            var result = await _authService.RegisterUserAsync(user, model.Password, UserRole.Supplier);
            if (!result.IsSucceed)
            {
